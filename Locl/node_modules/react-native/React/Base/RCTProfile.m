...
//Took this out to resolve error "Unused parameter sel and self" in RCTProfile.m", place this back in if an error occurs - Corey

static IMP RCTProfileMsgForward(NSObject *self, SEL selector)
//static IMP RCTProfileMsgForward()
{
